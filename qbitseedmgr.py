...
def set_tiers():
	for torrent in client.torrents_info():
		...
		# Set Tier 0
		elif (ratio >= 0) and (ratio < config["Tier 0"]["ratio_limit"]):
		...
		# Set Tier 1
		elif (ratio >= config["Tier 0"]["ratio_limit"]) and (ratio < config["Tier 1"]["ratio_limit"]):
		...
		# Set Tier 2
		elif (ratio >= config["Tier 1"]["ratio_limit"]) and (ratio < config["Tier 2"]["ratio_limit"]):
		...
		# Set Tier 3
		elif (ratio >= config["Tier 2"]["ratio_limit"]) and (ratio < config["Tier 3"]["ratio_limit"]):
		...
		# Set Tier 4
		elif (ratio >= config["Tier 3"]["ratio_limit"]) and (ratio < config["Tier 4"]["ratio_limit"]):
		...
		# Set Tier 5
		elif (ratio >= config["Tier 4"]["ratio_limit"]) and (ratio < config["Tier 5"]["ratio_limit"]):
		...
		# Set Tier 6
		elif (ratio >= config["Tier 5"]["ratio_limit"]) and (ratio < config["Tier 6"]["ratio_limit"]):
		...
		# Set Tier 7
		elif (ratio >= config["Tier 6"]["ratio_limit"]) and (ratio < config["Tier 7"]["ratio_limit"]):
		...
		# Set Tier 8
		elif (ratio >= config["Tier 7"]["ratio_limit"]) and (ratio < config["Tier 8"]["ratio_limit"]):
		...
		# Set Tier 9
		elif (ratio >= config["Tier 8"]["ratio_limit"]) and (ratio < config["Tier 9"]["ratio_limit"]):
